                ...
                <section>
                    ...
                    <div className="flex flex-col items-center w-full px-4 pb-16 max-w-5xl mx-auto">
                        ...
                        >
                            ...
                            <label htmlFor="interests" className="text-gray-700 font-semibold">
                                Hobbies / Interests
                            </label>
                            <input
                                id="interests"
                            ...
                            <label htmlFor="gift-type" className="text-gray-700 font-semibold">
                                Gift Type
                            </label>
                            <input
                                id="gift-type"
                            ...
                            <label htmlFor="budget-range" className="text-gray-700 font-semibold">
                                Budget Range
                            </label>
                            <input
                                id="budget-range"
                    ...
                    {ideas.length > 0 && (
                        // login
                        <h1 ref={GiftSuggest} className=" text-center mb-8 text-[#737791] text-[24px] ">
                            Gift suggestions
                        </h1>
                    )}
                    ...
                    <div className="max-w-300 mx-auto px-4">
                        {ideas.map((idea, index) => (
                            <div key={index} className="mb-4">
                                ...
                                <div className="flex flex-col gap-3 w-full min-w-75 p-6 pt-3 bg-[#e6f9ff] rounded-[20px] shadow-[0_6px_15px_rgba(0,0,0,0.08)]">
